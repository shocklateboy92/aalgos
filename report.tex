...
When dealing with concurrent or distributed programming, a correctness model including some temporal reasoning, or consistency.
...
While the others would be unintuitive, and difficult to reason about in a concurrent
