...
We present a proof that the \op{push\_back} operation is $k$-linearizable. Following \citet{dechev06}, we use linearization points to reason about the translation of a concurrent history to a sequential one.
